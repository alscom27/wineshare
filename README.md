...
[](./wineshareReadmeImages/main_newPlace.png)

# 주요 화면
| 메인                                                                                                                                                                                                                                                                                                           |회원가입|
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---|
| <img src="./wineshareReadmeImages/main_slide.png" width="400px" height="250px" alt="main1"></img><img src="./wineshareReadmeImages/main_recommended.png" width="400px" height="250px" alt="main2"></img><img src="./wineshareReadmeImages/main_newPlace.png" width="400px" height="250px" alt="main3"></img> |<img src="src/main/resources/static/images/sign.png" width="400px" height="250px" alt="sign"></img>|
| 공연목록                                                                                                                                                                                                                                                                                                         |공연상세|
